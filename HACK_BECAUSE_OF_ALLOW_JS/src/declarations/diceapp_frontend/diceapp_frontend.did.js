export const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        'certified_tree': IDL.Func([IDL.Record({})], [
            IDL.Record({
        ...
        'get': IDL.Func([IDL.Record({ 'key': Key, 'accept_encodings': IDL.Vec(IDL.Text) })], [
            IDL.Record({
        ...
        'get_asset_properties': IDL.Func([Key], [
            IDL.Record({
                'headers': IDL.Opt(IDL.Vec(HeaderField)),
